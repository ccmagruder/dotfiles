...
describe("bat.init", function()
  ...
  describe("open_window", function()
    it("should open a window on the right side of a vertical split", function()
    ...
    it("should refocus on existing window without creating a new one", function()
      -- Get initial state
      local original_window = vim.api.nvim_get_current_win()

      -- First call: opens the bat window
      bat.open_window()
      local bat_window = vim.api.nvim_get_current_win()
      ...
      -- Second call: should refocus, not create new window
      bat.open_window()
